...
import { FiHome, FiBox, FiStar, FiDollarSign, FiPackage, FiTrendingUp, FiCpu, FiLogOut, FiChevronLeft, FiChevronRight, FiMessageSquare, FiImage } from 'react-icons/fi';
import './Sidebar.css';
...
const Sidebar = ({ isCollapsed, toggleSidebar }) => {
    ...
    return (
        <div className={`sidebar ${isCollapsed ? 'collapsed' : ''}`}>
            <div className="sidebar-header">
                {!isCollapsed && <h2 className="sidebar-brand">Market AI Tool</h2>}
    ...
    <FiImage />
    {!isCollapsed && <span>Image Editor</span>}
</NavLink>
