        ...
        <div className="photoshop-editor">
            <div className="toolbar-container">
                <div className="tools">
                    ...
                    <button 
                        className="tool-button"
                        onClick={() => handleCanvasResize('maximize')}
                    ...
                    <button 
                        className="tool-button"
                        onClick={() => handleCanvasResize('minimize')}
                ...
                <button 
                    className={`tool-button ${tool === 'adjustments' ? 'active' : ''}`}
                    onClick={() => handleToolChange('adjustments')}
                    title="Adjustments"
                >
                    <FiSliders />
                </button>
                ...
                <button 
                    ...
                    onClick={() => setFilters(prev => ({
                        ...prev,
                        brightness: prev.brightness + 0.1
                    }))}
