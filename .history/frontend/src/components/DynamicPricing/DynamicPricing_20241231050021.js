...
const DynamicPricing = () => {
  ...
  return (
    <div className="dynamic-pricing-c">
  ...
  {formatCurrency(pricingData.min_price, pricingData.currency || 'INR')} - {formatCurrency(pricingData.max_price, pricingData.currency || 'INR')}
</p>
