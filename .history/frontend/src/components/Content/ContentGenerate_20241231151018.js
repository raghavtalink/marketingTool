    ...
    const formatFullListing = (content) => {
        ...
        return sections.map((line, index) => {
            ...
            if (line.includes(':')) {
                ...
                if (title.trim().toUpperCase() === title.trim()) {
                    // Section header
                    return <h4 key={index}>{title.trim()}</h4>;
            ...
            if (line.includes('Price:')) {
                return <div key={index} className="price">{line}</div>;
            }
            
            // Handle call to action
            if (line.includes('Call to Action:')) {
                return <div key={index} className="call-to-action">{line.replace('Call to Action:', '').trim()}</div>;
            }
                ...
                return (
                    <div className="generated-content">
                        <div className="content-section">
                            ...
                            <BotResponse htmlContent={content} isSEO={false} />
                        </div>
                    </div>
                );
            case 'seo':
                return (
                    <div className="generated-content">
                        <div className="content-section">
                            <h3>SEO Keywords</h3>
                            <BotResponse htmlContent={content} isSEO={true} />
                        </div>
                    </div>
                );
            case 'description':
                ...
                return (
                    <div className="generated-content">
                        <div className="content-section">
                            ...
                            <div className="full-listing-content">
                                {formatFullListing(content)}
                            </div>
                        </div>
                    </div>
                );
