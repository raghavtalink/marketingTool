        ...
        <div className="landing-page">
            <section className="hero-section relative min-h-screen flex items-center justify-center">
                ...
                <div className="hero-content relative z-10 text-center max-w-4xl mx-auto px-4">
                    ...
                    >
                        Welcome to <span>Sellovate</span>
                    </motion.h1>
                    ...
                    <motion.button 
                        className="cta-button text-xl px-8 py-4 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 transform hover:scale-105 transition-all"
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
