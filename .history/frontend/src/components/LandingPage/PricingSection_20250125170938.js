...
const PricingSection = () => {
    ...
    useEffect(() => {
        const ctx = gsap.context(() => {
            ...
            // Cards animation with better timing
            ...
            // Table animation with improved timing
        ...
        <section ref={sectionRef} className="pricing-section">
            ...
            <div className="content-wrapper">
                ...
                <div className="pricing-cards-container">
                    <div ref={cardsRef} className="pricing-cards">
                ...
                <motion.div 
                    ...
                    transition={{ duration: 0.6 }}
                >
                    <h3 className="gradient-text">Detailed Feature Comparison</h3>
