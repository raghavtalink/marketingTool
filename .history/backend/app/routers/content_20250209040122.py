    ...
    try:
        ...
        if search_web and last_message:
            try:
                ...
                # Enhance the search query with specific terms
                search_query = f"{last_message} MacBook Air M3 2024 comparison review"
        ...
        When web data is provided, prioritize using that information for current market comparisons.
        ...
        # Make sure to pass both the conversation and web_data
        response = call_llama3(conversation, web_data)
        
        return JSONResponse({
            "content": response,
            "format": "html",
            "web_data_used": bool(web_data)  # This will now be true when web data is actually fetched
        })
