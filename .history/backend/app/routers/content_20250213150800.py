    ...
    try:
        ...
        if search_web and last_message:
            try:
                ...
                search_query = f"Comprehensive insights on {last_message}, including key details, expert opinions, latest updates, comparisons, and any crucial information that enhances understanding."
