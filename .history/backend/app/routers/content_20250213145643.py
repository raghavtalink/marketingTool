    ...
    try:
        ...
        if search_web and last_message:
            try:
                ...
                search_query = f"Comprehensive insights on {user_input}, including key details, expert opinions, latest updates, comparisons, and any crucial information that enhances understanding."
