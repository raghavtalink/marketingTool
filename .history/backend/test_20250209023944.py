...
def call_llama3(query, structured_context):
    ...
    # Ensure correct extraction from Llama response
    if "choices" in data and len(data["choices"]) > 0:
        return data["choices"][0].get("message", {}).get("content", "No valid response found.")
...
# Example usage
query = "ind vs pak cricket match in 2025 date"
