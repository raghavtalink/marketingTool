...
const TrendSpot = () => {
  ...
  // Modify fetchTrendData to use selected productId if available
  ...
  if (error) {
    return (
      <div className="bg-red-500/20 border border-red-500 rounded-lg p-4 text-center">
        <p className="text-red-400">Failed to load trend data. Please try again.</p>
        <button 
          onClick={fetchTrendData}
          className="mt-4 px-4 py-2 bg-gray-800 rounded-md text-gray-200 hover:bg-gray-700"
        >
          Retry
        </button>
      </div>
