...
const ProductGenius = () => {
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Fixed Header */}
      <div className="sticky top-0 z-10 bg-gradient-to-r from-gray-800/80 to-gray-900/80 backdrop-blur-lg border-b border-gray-700 p-4 rounded-t-xl">
      ...
      {/* Fixed Input Area */}
      <div className="sticky bottom-0 z-10 p-4 border-t border-gray-700 bg-gradient-to-r from-gray-800/80 to-gray-900/80 backdrop-blur-lg rounded-b-xl">
        <div className="flex items-center">
          <textarea
            value={inputMessage}
