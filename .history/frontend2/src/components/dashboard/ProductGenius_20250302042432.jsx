...
const ProductGenius = () => {
  ...
  return (
    <div className="h-full flex flex-col relative">
      ...
      {/* Fixed Input Area */}
      <div className="absolute bottom-0 left-0 right-0 z-20 p-4 bg-gradient-to-r from-gray-800/90 to-gray-900/90 backdrop-blur-lg border-t border-gray-700 rounded-b-xl">
        <div className="flex items-center">
          <textarea
            value={inputMessage}
