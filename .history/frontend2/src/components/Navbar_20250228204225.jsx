    ...
    >
      <nav className="container mx-auto flex items-center justify-between w-full">
        ...
        <div className="hidden lg:flex space-x-4">
          ...
          <button className="bg-white text-black px-4 py-2 rounded-md text-sm font-semibold flex items-center hover:bg-gray-200">
      ...
      {isOpen && (
        <div className="lg:hidden bg-black border-t border-gray-800 px-4 pb-4 w-full rounded-lg">
          ...
          <div className="flex flex-col space-y-2 mt-4">
            ...
            <button className="bg-white text-black py-2 rounded-md text-sm font-semibold flex items-center justify-center hover:bg-gray-200">
