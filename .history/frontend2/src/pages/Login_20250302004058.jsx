  ...
  return (
    <div className="min-h-screen bg-black pt-28 text-gray-100 overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden opacity-20">
        <div className="absolute -top-40 -left-40 w-80 h-80 bg-purple-700 rounded-full mix-blend-multiply filter blur-3xl"></div>
        <div className="absolute top-0 -right-20 w-80 h-80 bg-blue-700 rounded-full mix-blend-multiply filter blur-3xl"></div>
        <div className="absolute -bottom-40 left-20 w-80 h-80 bg-pink-700 rounded-full mix-blend-multiply filter blur-3xl"></div>
      </div>
