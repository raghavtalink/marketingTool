...
const RegisterPage = () => {
  ...
  const [registerUser, { loading, error: apolloError }] = useMutation(REGISTER_USER, {
    ...
    onError: (error) => {
      ...
      // Method 1: Try to get from graphQLErrors
      if (error.graphQLErrors && error.graphQLErrors.length > 0) {
        errorMessage = error.graphQLErrors[0].message;
        console.log('Method 1 error:', errorMessage);
      } 
      // Method 2: Try to get from networkError
        ...
        console.log('Method 2 error:', errorMessage);
      }
      // Method 3: Just use the message property
    ...
    <div className="min-h-screen bg-black pt-28 text-gray-100 overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-md mx-auto py-12 px-4">
        ...
        >
          ...
          {debugError && (
            <div className="mb-4 p-3 bg-yellow-900/50 border border-yellow-800 rounded-lg">
              <p className="text-yellow-400 text-sm font-mono whitespace-pre-wrap">Debug Error: {debugError}</p>
            </div>
          )}
          ...
          {apolloError && (
            <div className="mb-4 p-3 bg-red-900/50 border border-red-800 rounded-lg">
              <p className="text-red-400 text-sm">Apollo Error: {apolloError.message}</p>
            </div>
          )}
