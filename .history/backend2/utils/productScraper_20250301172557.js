...
function extractFlipkartData($, url) {
    ...
    // Price
    const priceSelectors = ['div._30jeq3._16Jk6d', 'div._30jeq3', 'div._25b18c > div'];
    ...
    // Description
    const descSelectors = ['div._1mXcCf.RmoJUa', 'div._1mXcCf', 'div._1UhVsV'];
    ...
    // Images
    const imageSelectors = ['img.q6DClP', 'div._2r_T1I img', 'img._396cs4'];
    const images = [];
    ...
    // Rating
    const ratingSelectors = ['div._3LWZlK', 'div._3LWZlK._1BLPMq'];
    ...
    // Reviews Count
    const reviewsCountSelectors = ['span._2_R_DZ', 'span._38sUEc'];
    ...
    // Reviews
    const reviewSelectors = ['div.t-ZTKy', 'p._2-N8zT'];
    const reviews = [];
    ...
    $('div._3k-BhJ').each((i, section) => {
      const sectionTitle = getText('._21Ahn-', section);
      const specsObj = {};
      $(section).find('tr._1s_Smc.row').each((j, row) => {
        const key = getText('td._1hKmbr', row);
        const value = getText('td._2vZqPX', row);
    ...
    // Features
    const featureSelectors = ['ul._1xgFaf li', 'div._2418kt li'];
    const features = [];
