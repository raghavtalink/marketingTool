...
function extractFlipkartData($, url) {
    ...
    // Extract price
    const priceSelectors = ['div._30jeq3._16Jk6d', 'div._30jeq3', 'div._1vC4OE._3qQ9m1', 'span._2j_7lZ'];
    ...
    // Extract description
    const descSelectors = ['div._1mXcCf.RmoJUa', 'div._1UhVsV', 'div._1mXcCf', 'p._2-N8zT'];
    ...
    // Extract images
    const imageSelectors = ['div._396cs4._2amPTt._3qGmMb img', 'img._396cs4', 'div.cxPAYn img'];
    const images = [];
    ...
    // Extract rating
    const ratingSelectors = ['div._3LWZlK', 'span._2_R_DZ', 'div._3LWZlK._1BLPMq'];
    ...
    const reviewsCountSelectors = ['span._2_R_DZ', 'div._3LWZlK + span'];
    ...
    // Extract reviews
    const reviewSelectors = ['div.t-ZTKy', 'div._6K-7Co', 'p._2-N8zT'];
    const reviews = [];
    ...
    // Extract features
    const featureSelectors = ['div._2418kt li', 'ul._1xgFaf li', 'div._3k-BhJ li'];
    const features = [];
    ...
    const categorySelectors = ['div._2olh4r a', 'div._2whKao', 'span._2whKao'];
    let category = 'Other';
    for (const selector of categorySelectors) {
      const cats = $(selector).map((i, el) => $(el).text().trim()).get().join(' > ');
      if (cats) {
        category = cats;
        break;
      }
